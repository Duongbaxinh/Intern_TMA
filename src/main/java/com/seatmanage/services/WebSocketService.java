...
public class WebSocketService extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage request) throws Exception {
        ...
        if ("auth".equals(type) && username != null && !username.isEmpty()) {
    ...
    public void sendNoticeToRoom(String roomId, String message) throws IOException, BadRequest {
        sendToRoom(roomId, "notice", Map.of("message", message));
    }
    ...
    public void sendToRole(String role, String type, Object data) throws BadRequest {
        sendToSessions(userRoles.get(role), type, role, data);
    }
